            ...
            <div>
                <div className=' bg-cover w-screen flex h-screen bg-[#F0F2FF] '>
                    ...
                    <div className="h-screen flex-auto">
                        ...
                        >
                            <div className="row-span-1 col-span-1 ring-2 ring-grey rounded flex flex-col justify-center items-center ">
                                <div
                            ...
                            <div className=" row-span-1 col-span-1 ring-2 ring-grey rounded">02</div>
                            <div className="row-span-2 col-span-2 ring-2 ring-grey rounded">03</div>
                        </div>
                    </div>
                </div>
            </div>
