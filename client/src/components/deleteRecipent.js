    ...
    return (
        <div className="fixed inset-0 z-auto bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center">
            <div className="border-t-8 border-t-black relative flex-col justify-center bg-white rounded-xl w-2/5">
                ...
                <div className="flex  text-lg  text-black font-bold pt-4 px-8 border-b-2 border-b-gray-100" >Xóa người nhận</div>
                <div className="flex  text-sm  text-black mb-2 mt-4 px-8 " >Bạn có xác nhận muốn xóa người này ra khỏi danh sách người nhận?</div>
                <div className="flex justify-end pb-4 px-8">
                    ...
                    <button id="handleRemove" onClick={handleRemoveClick} className=" rounded px-2 py-2 ml-4 text-white  text-xs font-bold bg-[#EA580C] hover:bg-[#cf4a04] disabled:bg-[#edb395] ">Remove</button>
                </div>
            </div>
        </div>
    );
