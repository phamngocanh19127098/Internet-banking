      ...
      >
        <div className="p-6  m-auto bg-white rounded-md shadow-xl shadow-rose-600/40 ring ring-2 ring-main-green lg:max-w-xl lg:min-w-[25%] items-center justify-center">
          ...
          <form className="mt-6 form" onSubmit={handleSubmit}>
            ...
            <div className="mt-6">
              <button className="cursor-pointer form__submit-button w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 bg-gradient-to-r from-[#076F32] to-[#41b06f] rounded-lg">
                Đăng nhập
              </button>
            </div>
          </form>
